...
SMOKE_IMAGE="${IFLOW_INSTALL_SMOKE_IMAGE:-${CLAWDBOT_INSTALL_SMOKE_IMAGE:-claw-install-smoke:local}}"
NONROOT_IMAGE="${IFLOW_INSTALL_NONROOT_IMAGE:-${CLAWDBOT_INSTALL_NONROOT_IMAGE:-claw-install-nonroot:local}}"
INSTALL_URL="${IFLOW_INSTALL_URL:-${CLAWDBOT_INSTALL_URL:-https://claw.bot/install.sh}}"
CLI_INSTALL_URL="${IFLOW_INSTALL_CLI_URL:-${CLAWDBOT_INSTALL_CLI_URL:-https://claw.bot/install-cli.sh}}"
