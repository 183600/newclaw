## Claw Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_claw-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm claw gateway --port 18789 --verbose
```
