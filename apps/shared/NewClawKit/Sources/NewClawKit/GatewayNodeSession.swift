...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.newclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.newclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: NewClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
