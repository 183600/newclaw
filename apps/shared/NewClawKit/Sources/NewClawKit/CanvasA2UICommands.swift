...
public enum NewClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct NewClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct NewClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
