...
public typealias NewClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias NewClawPlatformImage = UIImage
#endif

public struct NewClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct NewClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: NewClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(NewClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct NewClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct NewClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [NewClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: NewClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [NewClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: NewClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(NewClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([NewClawChatMessageContent].self, forKey: .content) {
...
public struct NewClawChatHistoryPayload: Codable, Sendable {
...
public struct NewClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct NewClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [NewClawSessionPreviewItem]
}

public struct NewClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [NewClawSessionPreviewEntry]

    public init(ts: Int, previews: [NewClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct NewClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct NewClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct NewClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct NewClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct NewClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct NewClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: NewClawPlatformImage?
...
public struct NewClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
