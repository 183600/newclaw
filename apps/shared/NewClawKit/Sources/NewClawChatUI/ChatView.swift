...
@MainActor
public struct NewClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: NewClawChatViewModel
    ...
    public init(
        viewModel: NewClawChatViewModel,
    ...
    private var visibleMessages: [NewClawChatMessage] {
        let base: [NewClawChatMessage]
    ...
    private func mergeToolResults(in messages: [NewClawChatMessage]) -> [NewClawChatMessage] {
    ...
    private func isToolResultMessage(_ message: NewClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: NewClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: NewClawChatMessage) -> String {
