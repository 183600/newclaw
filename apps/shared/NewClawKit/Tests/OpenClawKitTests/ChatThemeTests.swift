...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = NewClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = NewClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
