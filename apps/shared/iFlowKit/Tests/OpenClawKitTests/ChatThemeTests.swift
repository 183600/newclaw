...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = iFlowChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = iFlowChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
