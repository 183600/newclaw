...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.iflow", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.iflow", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: iFlowProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
