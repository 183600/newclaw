...
public enum iFlowCanvasA2UICommand: String, Codable, Sendable {
...
public struct iFlowCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct iFlowCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
