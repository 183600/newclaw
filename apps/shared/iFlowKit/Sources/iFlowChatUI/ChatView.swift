...
@MainActor
public struct iFlowChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: iFlowChatViewModel
    ...
    private var visibleMessages: [iFlowChatMessage] {
        let base: [iFlowChatMessage]
    ...
    private func mergeToolResults(in messages: [iFlowChatMessage]) -> [iFlowChatMessage] {
    ...
    private func isToolResultMessage(_ message: iFlowChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: iFlowChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: iFlowChatMessage) -> String {
