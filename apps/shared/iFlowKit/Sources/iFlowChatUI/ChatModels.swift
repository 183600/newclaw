...
public typealias iFlowPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias iFlowPlatformImage = UIImage
#endif

public struct iFlowChatUsageCost: Codable, Hashable, Sendable {
...
public struct iFlowChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: iFlowChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(iFlowChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct iFlowChatMessageContent: Codable, Hashable, Sendable {
...
public struct iFlowChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [iFlowChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: iFlowChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [iFlowChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: iFlowChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(iFlowChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([iFlowChatMessageContent].self, forKey: .content) {
...
public struct iFlowChatHistoryPayload: Codable, Sendable {
...
public struct iFlowSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct iFlowSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [iFlowSessionPreviewItem]
}

public struct iFlowSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [iFlowSessionPreviewEntry]

    public init(ts: Int, previews: [iFlowSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct iFlowChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct iFlowChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct iFlowAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct iFlowChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct iFlowGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct iFlowPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: iFlowPlatformImage?
...
public struct iFlowChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
