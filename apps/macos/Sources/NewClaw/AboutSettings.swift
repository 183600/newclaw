...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/newclaw/newclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/newclaw/newclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://newclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "NewClawBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "NewClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "NewClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "NewClawGitCommit") as? String) ??
            "unknown"
    }
