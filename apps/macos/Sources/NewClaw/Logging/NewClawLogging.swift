...
enum NewClawLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = NewClawOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = NewClawFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        NewClawLogging.bootstrapIfNeeded()
        let label = NewClawLogging.makeLabel(subsystem: subsystem, category: category)
...
struct NewClawOSLogHandler: LogHandler {
...
struct NewClawFileLogHandler: LogHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = NewClawLogging.parseLabel(self.label)
