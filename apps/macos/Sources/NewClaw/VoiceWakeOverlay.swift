...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.newclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other NewClaw windows, but below the system’s pop-up menus.
