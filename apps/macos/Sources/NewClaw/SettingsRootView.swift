...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .newclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? NewClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? NewClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let newclawSelectSettingsTab = Notification.Name("newclawSelectSettingsTab")
}
