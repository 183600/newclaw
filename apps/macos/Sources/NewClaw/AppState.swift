...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = NewClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = NewClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = NewClawConfigFile.loadDict()
            ...
            NewClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/newclaw"
        state.remoteCliPath = ""
        return state
    }
}
