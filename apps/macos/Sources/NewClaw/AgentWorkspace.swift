...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.newclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return NewClawConfigFile.defaultWorkspaceURL() }
