...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.newclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("NewClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__newclaw__/a2ui/").absoluteString + "?platform=macos"
    }
