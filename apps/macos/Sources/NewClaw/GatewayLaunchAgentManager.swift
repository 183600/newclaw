...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.newclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".newclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.newclawCommand(
            subcommand: "gateway",
