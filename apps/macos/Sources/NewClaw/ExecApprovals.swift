...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.newclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        NewClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        NewClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
