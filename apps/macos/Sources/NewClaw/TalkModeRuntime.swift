...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.newclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.newclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [NewClawChatMessage] = messages.compactMap { item in
