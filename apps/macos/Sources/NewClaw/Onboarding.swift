...
enum UIStrings {
    static let welcomeTitle = "Welcome to NewClaw"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: NewClawOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: NewClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g newclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: NewClawChatViewModel(
