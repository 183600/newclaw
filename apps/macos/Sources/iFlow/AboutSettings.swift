...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/iflow/iflow") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/iflow/iflow")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://iflow.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "iFlowBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "iFlowBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "iFlowGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "iFlowGitCommit") as? String) ??
            "unknown"
    }
