...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.iflow", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.iflow", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [iFlowChatMessage] = messages.compactMap { item in
