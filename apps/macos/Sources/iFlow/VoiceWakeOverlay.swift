...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.iflow", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other iFlow windows, but below the system’s pop-up menus.
