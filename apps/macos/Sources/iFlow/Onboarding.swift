...
enum UIStrings {
    static let welcomeTitle = "Welcome to iFlow"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: iFlowOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: iFlowChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g iflow@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: iFlowChatViewModel(
