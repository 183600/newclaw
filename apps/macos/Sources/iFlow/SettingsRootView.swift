...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .iflowSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? iFlowPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? iFlowPaths.stateDirURL.path
...
extension Notification.Name {
    static let iflowSelectSettingsTab = Notification.Name("iflowSelectSettingsTab")
}
