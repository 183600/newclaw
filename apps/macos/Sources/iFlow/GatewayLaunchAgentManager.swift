...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.iflow", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".iflow/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.iflowCommand(
            subcommand: "gateway",
