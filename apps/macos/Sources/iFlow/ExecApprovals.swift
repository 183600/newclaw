...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.iflow", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        iFlowPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        iFlowPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
