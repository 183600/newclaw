...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.iflow", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("iFlow/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__iflow__/a2ui/").absoluteString + "?platform=macos"
    }
