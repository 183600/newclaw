...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = iFlowConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = iFlowConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = iFlowConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/iflow"
        state.remoteCliPath = ""
        return state
    }
}
