...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = iFlowLocationMode.off.rawValue
    ...
    private var locationMode: iFlowLocationMode {
        iFlowLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
