...
For threat model + hardening guidance (including `newclaw security audit --deep` and `--fix`), see:

- `https://docs.newclaw.ai/gateway/security`
...
docker run --read-only --cap-drop=ALL \
  -v newclaw-data:/app/data \
  newclaw/newclaw:latest
```
