...
export function listGoogleChatAccountIds(cfg: NewClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: NewClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: NewClawConfig): ResolvedGoogleChatAccount[] {
