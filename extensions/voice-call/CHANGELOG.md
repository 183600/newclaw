...
- Version alignment with core NewClaw release numbers.
...
- First public release of the @newclaw/voice-call plugin.
...
- CLI: `newclaw voicecall` commands (call/start/continue/speak/end/status/tail/expose).
