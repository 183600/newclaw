...
export function listBlueBubblesAccountIds(cfg: iFlowConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: iFlowConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: iFlowConfig): ResolvedBlueBubblesAccount[] {
