...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.IFLOW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: iFlowConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: iFlowConfig): string {
...
function mergeTelegramAccountConfig(cfg: iFlowConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: iFlowConfig): ResolvedTelegramAccount[] {
