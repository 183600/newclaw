...
export const PLUGIN_MANIFEST_FILENAME = "newclaw.plugin.json";
...
// package.json "newclaw" metadata (used for onboarding/catalog)
...
export type NewClawPackageManifest = {
  extensions?: string[];
...
): NewClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
