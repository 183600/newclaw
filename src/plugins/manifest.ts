...
export const PLUGIN_MANIFEST_FILENAME = "iflow.plugin.json";
...
// package.json "iflow" metadata (used for onboarding/catalog)
...
export type iFlowPackageManifest = {
  extensions?: string[];
...
): iFlowPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
