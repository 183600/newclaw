...
export type ChannelAgentToolFactory = (params: { cfg?: iFlowConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: iFlowConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: iFlowConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: iFlowConfig }) => boolean;
  supportsCards?: (params: { cfg: iFlowConfig }) => boolean;
