...
import type { loadiFlowPlugins } from "../plugins/loader.js";
...
export async function startGatewaySidecars(params: {
  ...
  pluginRegistry: ReturnType<typeof loadiFlowPlugins>;
  ...
  if (!isTruthyEnvValue(process.env.IFLOW_SKIP_GMAIL_WATCHER)) {
    try {
