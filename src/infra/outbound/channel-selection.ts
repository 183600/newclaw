...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: iFlowConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: iFlowConfig): Promise<MessageChannelId[]> {
