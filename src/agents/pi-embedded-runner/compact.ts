...
import { resolveNewClawDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  const agentDir = params.agentDir ?? resolveNewClawAgentDir();
  await ensureNewClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createNewClawCodingTools({
      exec: {
    ...
    const docsPath = await resolveNewClawDocsPath({
      workspaceDir: effectiveWorkspace,
