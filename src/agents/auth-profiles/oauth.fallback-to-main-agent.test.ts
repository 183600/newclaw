...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveNewClawAgentDir() returns mainAgentDir
    process.env.NEWCLAW_STATE_DIR = tmpDir;
    process.env.NEWCLAW_AGENT_DIR = mainAgentDir;
