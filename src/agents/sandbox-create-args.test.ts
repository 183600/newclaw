  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "newclaw.sandbox=1",
        "--label",
        "newclaw.sessionKey=main",
        "--label",
        "newclaw.createdAtMs=1700000000000",
        "--label",
        "newclaw.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
