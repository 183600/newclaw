...
export function resolveClawAgentDir(): string {
...
export function ensureClawAgentEnv(): string {
  const dir = resolveClawAgentDir();
...
/** @deprecated Use resolveClawAgentDir instead */
export function resolveiFlowAgentDir(): string {
  return resolveClawAgentDir();
}
