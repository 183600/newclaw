...
function resolveAvatarSource(cfg: iFlowConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: iFlowConfig, agentId: string): AgentAvatarResolution {
