...
function resolveAvatarSource(cfg: NewClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: NewClawConfig, agentId: string): AgentAvatarResolution {
