...
describe("createNewClawCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createNewClawCodingTools({
      config,
    ...
    const anthropicTools = createNewClawCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createNewClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createNewClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
