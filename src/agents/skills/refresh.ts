...
function resolveWatchPaths(workspaceDir: string, config?: iFlowConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: iFlowConfig }) {
