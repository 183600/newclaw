...
function resolveWatchPaths(workspaceDir: string, config?: NewClawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: NewClawConfig }) {
