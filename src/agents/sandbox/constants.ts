...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".newclaw", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "newclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "newclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "newclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "newclaw-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "newclaw-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".newclaw");
