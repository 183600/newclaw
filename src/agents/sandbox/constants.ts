...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".iflow", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "iflow-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "iflow-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "iflow-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "iflow-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "iflow-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".iflow");
