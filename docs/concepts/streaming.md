...
iFlow has two separate “streaming” layers:
...
When block streaming is enabled, iFlow can **merge consecutive block chunks**
...
When draft streaming is active, iFlow disables block streaming for that reply to avoid double-streaming.
