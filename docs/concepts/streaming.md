...
NewClaw has two separate “streaming” layers:
...
When block streaming is enabled, NewClaw can **merge consecutive block chunks**
...
When draft streaming is active, NewClaw disables block streaming for that reply to avoid double-streaming.
