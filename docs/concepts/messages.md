...
This page ties together how iFlow handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. iFlow keeps a
...
iFlow separates the **prompt body** from the **command body**:
...
iFlow can expose or hide model reasoning:
