...
You can point iFlow at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or iFlow
...
- [Anthropic provider](/providers/anthropic) - Native iFlow integration with Claude setup-token or API keys
