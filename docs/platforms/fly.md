...
```bash
# List current IPs
fly ips list -a my-iflow

# Release public IPs
fly ips release <public-ipv4> -a my-iflow
fly ips release <public-ipv6> -a my-iflow
...
fly ips allocate-v6 --private -a my-iflow
```
...
fly proxy 3000:3000 -a my-iflow
