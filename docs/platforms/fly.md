...
fly apps create my-newclaw

# Create a persistent volume (1GB is usually enough)
fly volumes create newclaw_data --size 1 --region iad
```
...
Or visit `https://my-newclaw.fly.dev/`
...
```bash
# List current IPs
fly ips list -a my-newclaw

# Release public IPs
fly ips release <public-ipv4> -a my-newclaw
fly ips release <public-ipv6> -a my-newclaw
...
fly ips allocate-v6 --private -a my-newclaw
```
...
fly proxy 3000:3000 -a my-newclaw
