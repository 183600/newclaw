...
<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @newclaw on X](https://x.com/newclaw).
</Info>
...
Asked “Robby” (@newclaw) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).
...
NewClaw connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/newclaw-ha-addon">
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/newclaw/nix-newclaw">
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @newclaw](https://x.com/newclaw)
  </Step>
