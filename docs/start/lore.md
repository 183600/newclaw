...
At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with newclaw."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @newclaw. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
- X handle `@newclaw` secured with GOLD CHECKMARK 💰
...
**The Scammer Speedrun:** Crypto grifters launched a $NEWCLAW token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
