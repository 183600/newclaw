...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up NewClaw?](#whats-the-recommended-way-to-install-and-set-up-newclaw)
  ...
  - [I can't access docs.newclaw.ai (SSL error). What now?](#i-cant-access-docsnewclawai-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or newclaw not recognized](#windows-install-says-git-not-found-or-newclaw-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install NewClaw on Linux?](#how-do-i-install-newclaw-on-linux)
  - [How do I install NewClaw on a VPS?](#how-do-i-install-newclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask NewClaw to update itself?](#can-i-ask-newclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run NewClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-newclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different NewClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-newclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run NewClaw on a dedicated machine?](#how-important-is-it-to-run-newclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run NewClaw in a VM and what are the requirements](#can-i-run-newclaw-in-a-vm-and-what-are-the-requirements)
- [What is NewClaw?](#what-is-newclaw)
  - [What is NewClaw, in one paragraph?](#what-is-newclaw-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for NewClaw](#what-are-the-top-five-everyday-use-cases-for-newclaw)
  - [Can NewClaw help with lead gen outreach ads and blogs for a SaaS](#can-newclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can NewClaw run tasks on a schedule or continuously in the background?](#can-newclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with NewClaw saved locally?](#is-all-data-used-with-newclaw-saved-locally)
  - [Where does NewClaw store its data?](#where-does-newclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall NewClaw?](#how-do-i-completely-uninstall-newclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the NewClaw browser run headless?](#can-the-newclaw-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two NewClaw instances talk to each other (local + VPS)?](#can-two-newclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does NewClaw load environment variables?](#how-does-newclaw-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of NewClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-newclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset NewClaw but keep it installed?](#how-do-i-completely-reset-newclaw-but-keep-it-installed)
  ...
  - [Why doesn’t NewClaw reply in a group?](#why-doesnt-newclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do NewClaw, Flawd, and Krill use for models?](#what-do-newclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [How do I run NewClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-newclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart NewClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-newclaw)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose NewClaw to inbound DMs?](#is-it-safe-to-expose-newclaw-to-inbound-dms)
...
Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-newclaw-store-its-data),
...
detail: [Troubleshooting](/help/troubleshooting#docsnewclawai-shows-an-ssl-error-comcastxfinity).
...
Not directly. macOS skills are gated by `metadata.newclaw.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-newclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured NewClaw workspace); NewClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.newclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- The Control UI stores the token in browser localStorage key `newclaw.control.settings.v1`.
...
Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.newclaw.*`, `newclaw-gateway-<profile>.service`, `NewClaw Gateway (<profile>)`).
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [NewClaw assistant setup](/start/newclaw) and [Agent send](/tools/agent-send).
