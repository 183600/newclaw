...
read_when:
  - Setting up Zalo Personal for iFlow
...
- Install via CLI: `iflow plugins install @iflow/zalouser`
- Or from a source checkout: `iflow plugins install ./extensions/zalouser`
...
- On startup, iFlow resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `iflow channels logout --channel zalouser && iflow channels login --channel zalouser`
