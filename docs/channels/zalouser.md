...
read_when:
  - Setting up Zalo Personal for NewClaw
...
- Install via CLI: `newclaw plugins install @newclaw/zalouser`
- Or from a source checkout: `newclaw plugins install ./extensions/zalouser`
...
- On startup, NewClaw resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `newclaw channels logout --channel zalouser && newclaw channels login --channel zalouser`
