...
- Install via CLI: `newclaw plugins install @newclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `newclaw plugins install ./extensions/zalo`
   - From npm (if published): `newclaw plugins install @newclaw/zalo`
...
- Example: `newclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `newclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `newclaw logs --follow`
