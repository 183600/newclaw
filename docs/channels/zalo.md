...
- Install via CLI: `iflow plugins install @iflow/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `iflow plugins install ./extensions/zalo`
   - From npm (if published): `iflow plugins install @iflow/zalo`
...
- Example: `iflow message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `iflow channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `iflow logs --follow`
