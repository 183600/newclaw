...
使用 Nix 运行 NewClaw 的推荐方式是通过 **[nix-newclaw](https://github.com/newclaw/nix-newclaw)** — 一个开箱即用的 Home Manager 模块。
...
> **📦 完整指南：[github.com/newclaw/nix-newclaw](https://github.com/newclaw/nix-newclaw)**
>
...
- [nix-newclaw](https://github.com/newclaw/nix-newclaw) — 完整设置指南
