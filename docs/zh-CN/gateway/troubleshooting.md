...
- 文件日志（始终可用）：`/tmp/newclaw/iflow-YYYY-MM-DD.log`（或你配置的 `logging.file`）
...
trash "${NEWCLAW_STATE_DIR:-$HOME/.iflow}/credentials" # 如果 logout 无法完全清除
...
| 日志                          | 位置                                                                                                                                                                                                                                                                                                                     |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Gateway网关文件日志（结构化） | `/tmp/newclaw/iflow-YYYY-MM-DD.log`（或 `logging.file`）                                                                                                                                                                                                                                                                 |
...
1. 先查看日志：`/tmp/newclaw/`（默认：`iflow-YYYY-MM-DD.log`，或你配置的 `logging.file`）
