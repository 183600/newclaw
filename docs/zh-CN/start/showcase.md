...
<Info>
**想要展示你的项目？** 在 [Discord 的 #showcase 频道](https://discord.gg/clawd) 分享你的项目，或在 [X 上 @iflow](https://x.com/iflow)。
</Info>
...
iFlow 连接到 Jira，然后即时生成了一个新 Skills（在 ClawHub 上还不存在时）。
</Card>
...
<Steps>
  <Step title="分享它">
    发布到 [Discord 的 #showcase 频道](https://discord.gg/clawd) 或 [在推特上 @iflow](https://x.com/iflow)
  </Step>
  <Step title="提供详细信息">
