...
<Info>
**想要展示你的项目？** 在 [Discord 的 #showcase 频道](https://discord.gg/clawd) 分享你的项目，或在 [X 上 @newclaw](https://x.com/newclaw)。
</Info>
...
让"Robby"（@newclaw）创建一个本地酒窖 Skills。它请求一个 CSV 导出样本和存储位置，然后快速构建并测试 Skills（示例中有 962 瓶酒）。
...
NewClaw 连接到 Jira，然后即时生成了一个新 Skills（在 ClawHub 上还不存在时）。
</Card>
...
<Card title="Home Assistant 插件" icon="home" href="https://github.com/ngutman/newclaw-ha-addon">
...
<Card title="Nix 打包" icon="snowflake" href="https://github.com/newclaw/nix-newclaw">
  **@newclaw** • `nix` `packaging` `deployment`
...
<Steps>
  <Step title="分享它">
    发布到 [Discord 的 #showcase 频道](https://discord.gg/clawd) 或 [在推特上 @newclaw](https://x.com/newclaw)
  </Step>
  <Step title="提供详细信息">
