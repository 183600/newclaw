...
**账号抢注者：** Twitter 改名后的几秒钟内，自动化机器人就抢注了 @newclaw。抢注者立即发布了一个加密货币钱包地址。Peter 联系了他在 X 的关系。
...
**骗子速通：** 加密货币骗子在几分钟内就在 Pump.fun 上推出了 $NEWCLAW 代币。他们盗用了 20 分钟前才创作的美术作品。经过企业认证的账号推送骗局。这份厚颜无耻几乎令人印象深刻。
