...
<p align="center">
  ...
  <a href="/">文档</a> ·
  <a href="/start/iflow">NewClaw 助手设置</a>
</p>
...
<p align="center">
  <img src="/whatsapp-iflow.jpg" alt="NewClaw（英文原图）" width="360" />
  <img src="/whatsapp-iflow-ai-zh.jpg" alt="NewClaw（AI 自动翻译）" width="360" />
  <br />
...
```json5
{
  ...
  messages: { groupChat: { mentionPatterns: ["@iflow"] } },
}
```
