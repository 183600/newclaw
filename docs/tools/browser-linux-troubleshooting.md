...
1. **Use the managed browser:** `newclaw browser start --browser-profile newclaw`
   (or set `browser.defaultProfile: "newclaw"`).
...
- Local `newclaw` profiles auto-assign `cdpPort`/`cdpUrl`; only set those for remote CDP.
